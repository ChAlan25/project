...
<body>
    <button class="bg-gray-500 text-black px-4 py-2 rounded hover:bg-gray-700 hover:cursor-pointer m-6"><a
            ...
            < back</a></button>
    <form action="{{ route('dashboard.cars.create') }}" method="POST" class="flex flex-col gap-4 p-5">
        @csrf
        @method('PUT')
        <table class="border-collapse border border-gray-300 gap-4">
            ...
            <tr>
                <td colspan="2" class="text-center"><button type="submit"
                        class=" bg-red-500 hover:bg-red-700 hover:cursor-pointer text-white font-bold py-2 px-4 rounded">Create</button>
                </td>
            </tr>
        </table>
    </form>

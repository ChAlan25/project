    ...
    public function run(): void
    {
        DB::table('cars')->insert([
            [
                ...
                'image_path' => 'https://images.unsplash.com/photo-1682695795557-17447f921a91',
                'quantity' => 1,
                'deleted_at' => null,
            ...
            [
                ...
                'image_path' => 'https://your-image-host.com/path/to/canam-maverick-x3.jpg',
                'quantity' => 1,
                'deleted_at' => null,
                'created_at' => Carbon::now(),
            ],
            [
                ...
                'image_path' => 'https://your-image-host.com/path/to/bmw-g80-m3.jpg',
                'quantity' => 1,
                'deleted_at' => null,
                'created_at' => Carbon::now(),
            ],
            [
                'name' => 'G80 M3 (Front View)',
                'brand' => 'BMW',
                'model' => 'M3 G80',
                'year' => 2023,
                'price' => 90000,
                'description' => 'BMW G80 M3, blue, front driving shot, large kidney grilles, aggressive look.',
                'image_path' => 'https://your-image-host.com/path/to/bmw-g80-m3-front.jpg',
                'quantity' => 1,
                'deleted_at' => null,
                'created_at' => Carbon::now(),
            ],
            [
                ...
                'image_path' => 'https://your-image-host.com/path/to/ford-mustang-gt.jpg',
                'quantity' => 1,
                'deleted_at' => null,
                'created_at' => Carbon::now(),
            ],
            [
                ...
                'image_path' => 'https://your-image-host.com/path/to/white-mustang-custom.jpg',
                'quantity' => 1,
                'deleted_at' => null,
                'created_at' => Carbon::now(),
            ],
            [
                'name' => 'Mustang GT (Orange Stripes)',
                'brand' => 'Ford',
                'model' => 'Mustang GT',
                'year' => 2020,
                'price' => 52000,
                'description' => 'Ford Mustang GT in orange with black racing stripes, modern American muscle car, front view at night.',
                'image_path' => 'https://your-image-host.com/path/to/orange-mustang-gt.jpg',
                'quantity' => 1,
                'deleted_at' => null,
                'created_at' => Carbon::now(),
            ],
